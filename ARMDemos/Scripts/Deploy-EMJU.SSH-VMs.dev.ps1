...
Param(
  ...
  [string] $ResourceGroupName = 'J4U-DEV-SSH-VMs',  
  [switch] $UploadArtifacts,
  [string] $StorageAccountName,
  [string] $StorageAccountResourceGroupName, 
  [string] $StorageContainerName = $ResourceGroupName.ToLowerInvariant() + '-stageartifacts',
  [string] $TemplateFile = '..\Templates\DeploymentTemplate-J4U.SSH-VMs.json',
  [string] $TemplateParametersFile = '..\Templates\DeploymentTemplate-J4U.SSH-VMs.param.dev.json',
