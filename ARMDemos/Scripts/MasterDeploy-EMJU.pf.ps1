...
$NetworkTemplate = "..\Templates\DeploymentTemplate-EMJU.Network.json"
$SSHBastionTemplate ="..\Templates\DeploymentTemplate-EMJU.SSH-VMs.json"
$PublicServiceTemplate = "..\Templates\DeploymentTemplate-EMJU.PublicService-VMs.json"
...
$invokeArgs += ("-TemplateParametersFile","..\Templates\DeploymentTemplate-EMJU.Network.param.dev.json")
...
$invokeArgs += ("-TemplateParametersFile","..\Templates\DeploymentTemplate-EMJU.SSH-VMs.param.pf.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateParametersFile","..\Templates\DeploymentTemplate-EMJU.PublicService-VMs-ClipEventProcessing.param.pf.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\DeploymentTemplate-EMJU.PublicService-VMs-Clipping.param.pf.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\DeploymentTemplate-EMJU.PublicService-VMs-CoreServices.param.pf.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\DeploymentTemplate-EMJU.PublicService-VMs-CoreServicesMobile.param.pf.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\DeploymentTemplate-EMJU.PublicService-VMs-Gallery.param.pf.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\DeploymentTemplate-EMJU.PublicService-VMs-GalleryMobile.param.pf.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\DeploymentTemplate-EMJU.PublicService-VMs-MiscServicesMobile.param.pf.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\DeploymentTemplate-EMJU.PublicService-VMs-MyCard.param.pf.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\DeploymentTemplate-EMJU.PublicService-VMs-MyList.param.pf.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\DeploymentTemplate-EMJU.PublicService-VMs-MyListMobile.param.pf.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\DeploymentTemplate-EMJU.PublicService-VMs-OfferSetup.param.pf.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\DeploymentTemplate-EMJU.PublicService-VMs-PartnerClipping.param.pf.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\DeploymentTemplate-EMJU.PublicService-VMs-ScanMobile.param.pf.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\DeploymentTemplate-EMJU.PublicService-VMs-SortByAisleMobile.param.pf.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\DeploymentTemplate-EMJU.PublicService-VMs-WeeklyAdMobile.param.pf.json")
$invokeArgs += $subscriptionArgs
