...
Param(
  ...
  [string] $ResourceGroupName = 'J4U-DEV-CLIP-VMs',  
  [switch] $UploadArtifacts,
  [string] $StorageAccountName,
  [string] $StorageAccountResourceGroupName, 
  [string] $StorageContainerName = $ResourceGroupName.ToLowerInvariant() + '-stageartifacts',
  [string] $TemplateFile = '..\Templates\DeploymentTemplate-J4U.PublicPlayService-VMs.json',
  [string] $TemplateParametersFile = '..\Templates\DeploymentTemplate-J4U.PublicPlayService-VMs.param.dev.json',
