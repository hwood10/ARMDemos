...
Param(
  ...
  [string] $ResourceGroupName = 'J4U-DEV-SFTP-VMs',  
  [switch] $UploadArtifacts,
  [string] $StorageAccountName,
  [string] $StorageAccountResourceGroupName, 
  [string] $StorageContainerName = $ResourceGroupName.ToLowerInvariant() + '-stageartifacts',
  [string] $TemplateFile = '..\Templates\DeploymentTemplate-J4U.SFTP-VMs.json',
  [string] $TemplateParametersFile = '..\Templates\DeploymentTemplate-J4U.SFTP-VMs.param.dev.json',
