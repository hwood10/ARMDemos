...
$invokeArgs += ("-TemplateParametersFile","..\Templates\EMJU.RdpJump-VMs.param.pf.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateParametersFile","..\Templates\EMJU.SFTP-VMs.param.pf.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateParametersFile","..\Templates\EMJU.PrivateService-VMs-Management.param.pf.json")
$invokeArgs += $subscriptionArgs
