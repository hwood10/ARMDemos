...
$invokeArgs += ("-TemplateParametersFile","..\Templates\EMJU.RdpJump-VMs.param.dev.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateParametersFile","..\Templates\EMJU.SFTP-VMs.param.dev.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateParametersFile","..\Templates\EMJU.SSH-VMs.param.dev.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateParametersFile","..\Templates\EMJU.PublicService-VMs-ClipEventProcessing.param.dev.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\EMJU.PublicService-VMs-Clipping.param.dev.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\EMJU.PublicService-VMs-CoreServices.param.dev.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\EMJU.PublicService-VMs-CoreServicesMobile.param.dev.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\EMJU.PublicService-VMs-Gallery.param.dev.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\EMJU.PublicService-VMs-GalleryMobile.param.dev.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\EMJU.PublicService-VMs-MiscServicesMobile.param.dev.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\EMJU.PublicService-VMs-MyCard.param.dev.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\EMJU.PublicService-VMs-MyList.param.dev.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\EMJU.PublicService-VMs-MyListMobile.param.dev.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\EMJU.PublicService-VMs-OfferSetup.param.dev.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\EMJU.PublicService-VMs-PartnerClipping.param.dev.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\EMJU.PublicService-VMs-ScanMobile.param.dev.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\EMJU.PublicService-VMs-SortByAisleMobile.param.dev.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateFile", $PublicServiceTemplate)
$invokeArgs += ("-TemplateParametersFile","..\Templates\EMJU.PublicService-VMs-WeeklyAdMobile.param.dev.json")
$invokeArgs += $subscriptionArgs
...
$invokeArgs += ("-TemplateParametersFile","..\Templates\EMJU.PrivateService-VMs-Management.param.dev.json")
$invokeArgs += $subscriptionArgs
